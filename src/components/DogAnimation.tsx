...
type DogAnimationProps = {
  /** Kartın en ölçüsü. Video 16:9 nisbətini avtomatik qoruyur (square=true olanda kvadrat olur). */
  width?: number;
  /** true olanda konteyner kvadrat olur (məs. digər heyvanlarla eyni ölçü şəbəkəsinə uyğunlaşmaq üçün). */
  square?: boolean;
...
export function DogAnimation({ width = 260, square, style }: DogAnimationProps) {
